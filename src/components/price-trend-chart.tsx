...
export default function PriceTrendChart() {
  ...
  useEffect(() => {
    ...
    const data = [
      18000, 18000, 17500, 17500, 17000, 17000, 16500, 16500, 16000, 16000,
      15500, 15500, 15000, 15000, 15000, 15500, 15500, 16000, 16000, 16500,
      16500, 16000, 15500, 15000, 15000, 14500, 14500, 15000, 15000, 15000,
    ];
    ...
    data.forEach((price, index) => {
      const x =
        padding + (canvas.width - 2 * padding) * (index / (data.length - 1));
      const y =
        padding +
