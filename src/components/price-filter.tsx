    ...
    <div className="bg-white p-4 rounded-lg shadow">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="px-3 py-1 bg-gray-100 rounded text-sm">{priceRange[0].toLocaleString()}원</div>
          <div className="px-3 py-1 bg-gray-100 rounded text-sm">{priceRange[1].toLocaleString()}원</div>
        </div>
