  ...
  return (
    <div>
        ...
        <div className="flex items-center space-x-4">
          <button
            className={`px-3 py-1 rounded text-sm ${
              sortBy === "recent" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
            }`}
          ...
          <button
            className={`px-3 py-1 rounded text-sm ${
              sortBy === "rating" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
            }`}
          ...
          <button
            className={`px-3 py-1 rounded text-sm ${
              sortBy === "likes" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
            }`}
      ...
      {showReviewForm && (
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          ...
          <form onSubmit={handleSubmitReview}>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">항목별 평가</label>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-sm text-gray-600 mb-1">타격감</label>
                  <div className="flex items-center">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="h-4 w-4 text-yellow-400" />
                    ))}
                ...
                <div>
                  <label className="block text-sm text-gray-600 mb-1">지속성</label>
                  <div className="flex items-center">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="h-4 w-4 text-yellow-400" />
                    ))}
      ...
      <div className="mt-6 text-center">
        <button className="flex items-center justify-center mx-auto px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
          더 보기
